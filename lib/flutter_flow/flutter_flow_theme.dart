...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF7ED321);
  late Color tertiary = const Color(0xFFF5A623);
  late Color alternate = const Color(0xFFD1D1D1);
  ...
  late Color accent1 = const Color(0xFFF8E71C);
  late Color accent2 = const Color(0xFF50E3C2);
  late Color accent3 = const Color(0xFF9013FE);
  late Color accent4 = const Color(0xFFE94E77);
  late Color success = const Color(0xFF7ED321);
  late Color warning = const Color(0xFFF5A623);
  late Color error = const Color(0xFFD0021B);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF6EBB4B);
  late Color tertiary = const Color(0xFFF39C12);
  late Color alternate = const Color(0xFFB0B0B0);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFA6A6A6);
  late Color primaryBackground = const Color(0xFF1C1C1E);
  late Color secondaryBackground = const Color(0xFF2C2C2E);
  late Color accent1 = const Color(0xFFF1C40F);
  late Color accent2 = const Color(0xFF1ABC9C);
  late Color accent3 = const Color(0xFF9B59B6);
  late Color accent4 = const Color(0xFFE74C3C);
  late Color success = const Color(0xFF27AE60);
  late Color warning = const Color(0xFFE67E22);
