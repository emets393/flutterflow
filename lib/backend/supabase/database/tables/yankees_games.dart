...
class YankeesGamesTable extends SupabaseTable<YankeesGamesRow> {
  @override
  String get tableName => 'yankees_games';

  @override
  YankeesGamesRow createRow(Map<String, dynamic> data) => YankeesGamesRow(data);
}

class YankeesGamesRow extends SupabaseDataRow {
  YankeesGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => YankeesGamesTable();
