...
class ColoradoGamesTable extends SupabaseTable<ColoradoGamesRow> {
  @override
  String get tableName => 'colorado_games';

  @override
  ColoradoGamesRow createRow(Map<String, dynamic> data) =>
      ColoradoGamesRow(data);
}

class ColoradoGamesRow extends SupabaseDataRow {
  ColoradoGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ColoradoGamesTable();
