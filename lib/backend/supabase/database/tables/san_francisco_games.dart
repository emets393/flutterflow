...
class SanFranciscoGamesTable extends SupabaseTable<SanFranciscoGamesRow> {
  @override
  String get tableName => 'san_francisco_games';

  @override
  SanFranciscoGamesRow createRow(Map<String, dynamic> data) =>
      SanFranciscoGamesRow(data);
}

class SanFranciscoGamesRow extends SupabaseDataRow {
  SanFranciscoGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SanFranciscoGamesTable();
