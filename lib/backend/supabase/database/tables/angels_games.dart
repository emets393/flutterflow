...
class AngelsGamesTable extends SupabaseTable<AngelsGamesRow> {
  @override
  String get tableName => 'angels_games';

  @override
  AngelsGamesRow createRow(Map<String, dynamic> data) => AngelsGamesRow(data);
}

class AngelsGamesRow extends SupabaseDataRow {
  AngelsGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AngelsGamesTable();
