...
class ClevelandGamesTable extends SupabaseTable<ClevelandGamesRow> {
  @override
  String get tableName => 'cleveland_games';

  @override
  ClevelandGamesRow createRow(Map<String, dynamic> data) =>
      ClevelandGamesRow(data);
}

class ClevelandGamesRow extends SupabaseDataRow {
  ClevelandGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ClevelandGamesTable();
