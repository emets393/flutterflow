...
class PittsburghGamesTable extends SupabaseTable<PittsburghGamesRow> {
  @override
  String get tableName => 'pittsburgh_games';

  @override
  PittsburghGamesRow createRow(Map<String, dynamic> data) =>
      PittsburghGamesRow(data);
}

class PittsburghGamesRow extends SupabaseDataRow {
  PittsburghGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PittsburghGamesTable();
