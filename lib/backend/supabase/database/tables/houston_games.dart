...
class HoustonGamesTable extends SupabaseTable<HoustonGamesRow> {
  @override
  String get tableName => 'houston_games';

  @override
  HoustonGamesRow createRow(Map<String, dynamic> data) => HoustonGamesRow(data);
}

class HoustonGamesRow extends SupabaseDataRow {
  HoustonGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => HoustonGamesTable();
