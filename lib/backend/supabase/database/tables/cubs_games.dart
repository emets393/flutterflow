...
class CubsGamesTable extends SupabaseTable<CubsGamesRow> {
  @override
  String get tableName => 'cubs_games';

  @override
  CubsGamesRow createRow(Map<String, dynamic> data) => CubsGamesRow(data);
}

class CubsGamesRow extends SupabaseDataRow {
  CubsGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CubsGamesTable();
