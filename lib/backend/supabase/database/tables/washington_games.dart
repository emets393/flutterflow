...
class WashingtonGamesTable extends SupabaseTable<WashingtonGamesRow> {
  @override
  String get tableName => 'washington_games';

  @override
  WashingtonGamesRow createRow(Map<String, dynamic> data) =>
      WashingtonGamesRow(data);
}

class WashingtonGamesRow extends SupabaseDataRow {
  WashingtonGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WashingtonGamesTable();
