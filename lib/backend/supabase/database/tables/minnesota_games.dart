...
class MinnesotaGamesTable extends SupabaseTable<MinnesotaGamesRow> {
  @override
  String get tableName => 'minnesota_games';

  @override
  MinnesotaGamesRow createRow(Map<String, dynamic> data) =>
      MinnesotaGamesRow(data);
}

class MinnesotaGamesRow extends SupabaseDataRow {
  MinnesotaGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MinnesotaGamesTable();
