...
class TorontoGamesTable extends SupabaseTable<TorontoGamesRow> {
  @override
  String get tableName => 'toronto_games';

  @override
  TorontoGamesRow createRow(Map<String, dynamic> data) => TorontoGamesRow(data);
}

class TorontoGamesRow extends SupabaseDataRow {
  TorontoGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TorontoGamesTable();
