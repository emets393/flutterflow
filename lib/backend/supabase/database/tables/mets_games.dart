...
class MetsGamesTable extends SupabaseTable<MetsGamesRow> {
  @override
  String get tableName => 'mets_games';

  @override
  MetsGamesRow createRow(Map<String, dynamic> data) => MetsGamesRow(data);
}

class MetsGamesRow extends SupabaseDataRow {
  MetsGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MetsGamesTable();
