...
class AthleticsGamesTable extends SupabaseTable<AthleticsGamesRow> {
  @override
  String get tableName => 'athletics_games';

  @override
  AthleticsGamesRow createRow(Map<String, dynamic> data) =>
      AthleticsGamesRow(data);
}

class AthleticsGamesRow extends SupabaseDataRow {
  AthleticsGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AthleticsGamesTable();
