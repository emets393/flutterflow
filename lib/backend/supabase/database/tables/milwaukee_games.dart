...
class MilwaukeeGamesTable extends SupabaseTable<MilwaukeeGamesRow> {
  @override
  String get tableName => 'milwaukee_games';

  @override
  MilwaukeeGamesRow createRow(Map<String, dynamic> data) =>
      MilwaukeeGamesRow(data);
}

class MilwaukeeGamesRow extends SupabaseDataRow {
  MilwaukeeGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MilwaukeeGamesTable();
