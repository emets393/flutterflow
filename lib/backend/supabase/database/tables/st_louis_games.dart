...
class StLouisGamesTable extends SupabaseTable<StLouisGamesRow> {
  @override
  String get tableName => 'st_louis_games';

  @override
  StLouisGamesRow createRow(Map<String, dynamic> data) => StLouisGamesRow(data);
}

class StLouisGamesRow extends SupabaseDataRow {
  StLouisGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => StLouisGamesTable();
