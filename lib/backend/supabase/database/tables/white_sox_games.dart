...
class WhiteSoxGamesTable extends SupabaseTable<WhiteSoxGamesRow> {
  @override
  String get tableName => 'white_sox_games';

  @override
  WhiteSoxGamesRow createRow(Map<String, dynamic> data) =>
      WhiteSoxGamesRow(data);
}

class WhiteSoxGamesRow extends SupabaseDataRow {
  WhiteSoxGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WhiteSoxGamesTable();
