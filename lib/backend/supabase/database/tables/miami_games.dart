...
class MiamiGamesTable extends SupabaseTable<MiamiGamesRow> {
  @override
  String get tableName => 'miami_games';

  @override
  MiamiGamesRow createRow(Map<String, dynamic> data) => MiamiGamesRow(data);
}

class MiamiGamesRow extends SupabaseDataRow {
  MiamiGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MiamiGamesTable();
