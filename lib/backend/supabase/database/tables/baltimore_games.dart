...
class BaltimoreGamesTable extends SupabaseTable<BaltimoreGamesRow> {
  @override
  String get tableName => 'baltimore_games';

  @override
  BaltimoreGamesRow createRow(Map<String, dynamic> data) =>
      BaltimoreGamesRow(data);
}

class BaltimoreGamesRow extends SupabaseDataRow {
  BaltimoreGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BaltimoreGamesTable();
