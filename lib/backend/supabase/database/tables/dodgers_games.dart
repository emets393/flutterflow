...
class DodgersGamesTable extends SupabaseTable<DodgersGamesRow> {
  @override
  String get tableName => 'dodgers_games';

  @override
  DodgersGamesRow createRow(Map<String, dynamic> data) => DodgersGamesRow(data);
}

class DodgersGamesRow extends SupabaseDataRow {
  DodgersGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DodgersGamesTable();
