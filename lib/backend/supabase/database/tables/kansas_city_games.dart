...
class KansasCityGamesTable extends SupabaseTable<KansasCityGamesRow> {
  @override
  String get tableName => 'kansas_city_games';

  @override
  KansasCityGamesRow createRow(Map<String, dynamic> data) =>
      KansasCityGamesRow(data);
}

class KansasCityGamesRow extends SupabaseDataRow {
  KansasCityGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => KansasCityGamesTable();
