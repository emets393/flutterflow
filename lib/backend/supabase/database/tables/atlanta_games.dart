...
class AtlantaGamesTable extends SupabaseTable<AtlantaGamesRow> {
  @override
  String get tableName => 'atlanta_games';

  @override
  AtlantaGamesRow createRow(Map<String, dynamic> data) => AtlantaGamesRow(data);
}

class AtlantaGamesRow extends SupabaseDataRow {
  AtlantaGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AtlantaGamesTable();
