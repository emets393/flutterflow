...
class DetroitGamesTable extends SupabaseTable<DetroitGamesRow> {
  @override
  String get tableName => 'detroit_games';

  @override
  DetroitGamesRow createRow(Map<String, dynamic> data) => DetroitGamesRow(data);
}

class DetroitGamesRow extends SupabaseDataRow {
  DetroitGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => DetroitGamesTable();
