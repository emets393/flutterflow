...
class PhiladelphiaGamesTable extends SupabaseTable<PhiladelphiaGamesRow> {
  @override
  String get tableName => 'philadelphia_games';

  @override
  PhiladelphiaGamesRow createRow(Map<String, dynamic> data) =>
      PhiladelphiaGamesRow(data);
}

class PhiladelphiaGamesRow extends SupabaseDataRow {
  PhiladelphiaGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PhiladelphiaGamesTable();
