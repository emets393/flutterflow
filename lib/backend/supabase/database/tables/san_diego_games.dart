...
class SanDiegoGamesTable extends SupabaseTable<SanDiegoGamesRow> {
  @override
  String get tableName => 'san_diego_games';

  @override
  SanDiegoGamesRow createRow(Map<String, dynamic> data) =>
      SanDiegoGamesRow(data);
}

class SanDiegoGamesRow extends SupabaseDataRow {
  SanDiegoGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SanDiegoGamesTable();
