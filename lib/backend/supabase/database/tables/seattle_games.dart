...
class SeattleGamesTable extends SupabaseTable<SeattleGamesRow> {
  @override
  String get tableName => 'seattle_games';

  @override
  SeattleGamesRow createRow(Map<String, dynamic> data) => SeattleGamesRow(data);
}

class SeattleGamesRow extends SupabaseDataRow {
  SeattleGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SeattleGamesTable();
