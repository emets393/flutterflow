...
class TexasGamesTable extends SupabaseTable<TexasGamesRow> {
  @override
  String get tableName => 'texas_games';

  @override
  TexasGamesRow createRow(Map<String, dynamic> data) => TexasGamesRow(data);
}

class TexasGamesRow extends SupabaseDataRow {
  TexasGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TexasGamesTable();
