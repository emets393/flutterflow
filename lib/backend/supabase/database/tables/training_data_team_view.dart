...
class TrainingDataTeamViewTable extends SupabaseTable<TrainingDataTeamViewRow> {
  @override
  String get tableName => 'training_data_team_view';

  @override
  TrainingDataTeamViewRow createRow(Map<String, dynamic> data) =>
      TrainingDataTeamViewRow(data);
}

class TrainingDataTeamViewRow extends SupabaseDataRow {
  TrainingDataTeamViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TrainingDataTeamViewTable();
