...
class TampaBayGamesTable extends SupabaseTable<TampaBayGamesRow> {
  @override
  String get tableName => 'tampa_bay_games';

  @override
  TampaBayGamesRow createRow(Map<String, dynamic> data) =>
      TampaBayGamesRow(data);
}

class TampaBayGamesRow extends SupabaseDataRow {
  TampaBayGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TampaBayGamesTable();
