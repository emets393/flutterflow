...
class ArizonaGamesTable extends SupabaseTable<ArizonaGamesRow> {
  @override
  String get tableName => 'arizona_games';

  @override
  ArizonaGamesRow createRow(Map<String, dynamic> data) => ArizonaGamesRow(data);
}

class ArizonaGamesRow extends SupabaseDataRow {
  ArizonaGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ArizonaGamesTable();
