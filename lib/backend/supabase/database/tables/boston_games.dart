...
class BostonGamesTable extends SupabaseTable<BostonGamesRow> {
  @override
  String get tableName => 'boston_games';

  @override
  BostonGamesRow createRow(Map<String, dynamic> data) => BostonGamesRow(data);
}

class BostonGamesRow extends SupabaseDataRow {
  BostonGamesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BostonGamesTable();
